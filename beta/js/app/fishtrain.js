...
let FishTrain = function(){
  ...
  class _FishTrain {
    ...
    loadExistingTrain(existingSchedule) {
      ...
      // NOTE: Teamcraft data doesn't include the timelineEnd. Infer this based on
      // the last scheduled fish, and add an extra interval's worth of time?
      // TODO: Just make the start/end times configurable without destroying the
      // existing schedule...
      // Hopefully, the schedule contains entries?  It really should...
      this.timeline.end = _(existingSchedule.scheduleEntries).last().range.end;
      ...
      // DO NOT mark schedule as dirty. Store the Teamcraft ID.
